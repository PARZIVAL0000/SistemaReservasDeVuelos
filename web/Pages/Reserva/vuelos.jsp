...
<html lang="en">
    ...
    <body>
                        ...
                        <section id="first-tab-group" class="tabgroup">
                            <div id="tab1">
                                <div class="submit-form">
                                    ...
                                    <p>Escoge una de las Aerolineas para tu viaje de ida y de vuelta</p>
                                </div>
                            </div>
                        </section>
                    </div>
        ...
        <!-- dentro de aqui vamos ir desplegando los diferentes vuelos que puede llegar a existir... -->
        <section class="vuelos">
            <div class="accordion" id="accordionExample">
                ...
                <!-- Nuestro segundo punto sobre los vuelos de regreso... -->
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                          Eligue tu vuelo de retorno: <%= paisDestino %> a <%= paisOrigen %>
                        </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        ...
                        <!-- Un despliegue de los posibles vuelos que puedan llegar a existir.... -->
                        <div class="listado_vuelos">
                            <% if(viajesRetorno.size() == 0){%>
                               <div class="vuelo" id="retorno">
                                    <p class="mensaje_vuelos">Sin vuelos disponibles...</p>
                               </div>
                            ...
                            <% }else{ %>
                                ...
                                <div class="vuelo id_<%= j.getId() %>" id="retorno">
                                    <section class="seccion1">
                                        ...
                                        <div class="seleccion">
                                            <div class="form-check">
                                                <input class="form-check-input fly_to" type="radio" name="aerolineaRetorno-<%= j.getId() %>" value="<%= j.getId() %>" id="ViajeRetorno1">
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                    <p>Quiero <%= j.getAerolinea() %></p>
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input fly_to" type="radio" name="aerolineaRetorno-<%= j.getId() %>" value="<%= j.getId() %>" id="ViajeRetorno2" checked>
                                                <label class="form-check-label" for="flexRadioDefault2">
                                                    <p>No Quiero <%= j.getAerolinea() %></p>
                                                </label>
                                            </div>
            ...
            </div><!-- Este contiene absolutamente mis dos secciones -->
        ...
        <div class="formulario_final <%= (accion.toLowerCase().equals("show_form") && (mensaje.equals("cedula_incorrecta") || mensaje.equals("entradas_incorrecta") ) ) ? mensaje : "" %>" style="<%= accion.toLowerCase().equals("show_form") ? "display:block" : "" %>">
            <div class="informacion">
                ...
                <form class="formulario_informacion" method="POST" action="ReservaControllers?accion=pagar">
                    <div class="secciones">
        ...
        <script src="js/scripts/vuelos.js"></script>
    </body>
</html>